...
class sale_order(osv.osv):
    ...
    _columns = {
        ...
        'oportunity_ref': fields.many2one('crm.lead','Oportunity Reference'),
    ...
    def print_quotation(self, cr, uid, ids, context=None):
        ...
        self.crm_stage(cr,uid,ids,5,context=context)
    ...
    def crm_stage(self, cr, uid, ids, stage, context):
        order = self.browse(cr, uid, ids, context)
        order_col = order[0]                
        crm_stage = self.pool.get('crm.lead')
        if order_col.oportunity_ref.id != False:
           crm_stage.write(cr, uid, [order_col.oportunity_ref.id], {'stage_id': stage}, context=context)
    ...
    def action_cancel(self, cr, uid, ids, context=None):
        ...
        self.crm_stage(cr, uid, ids, 8, context)
        return True
    ...
    def action_button_confirm(self, cr, uid, ids, context=None):
        ...
        view_ref = self.pool.get('ir.model.data').get_object_reference(cr, uid, 'sale', 'view_order_form')
        view_id = view_ref and view_ref[1] or False,
        self.crm_stage(cr, uid, ids, 7, context)
        return {
            'type': 'ir.actions.act_window',
            'name': _('Sales Order'),
            'res_model': 'sale.order',
    ...
    def action_quotation_send(self, cr, uid, ids, context=None):
        ...
        '''
        self.crm_stage(cr, uid, ids, 5, context)
